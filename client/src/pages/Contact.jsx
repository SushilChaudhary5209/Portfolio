      ...
      <div className='flex flex-col justify-center items-center md:flex-row'>
        <div className='w-full md:w-[50%] flex flex-col justify-center gap-10 px-4 md:px-20'>
          ...
          {/* <div className='flex items-center justify-center gap-3 pt-4'>
            ...
            <a href="#" className="hover:text-gray-400"><FaSquareFacebook className='size-10' /></a>
            <a href="#" className="hover:text-gray-400"><FaInstagram className='size-10' /></a>
            <a href="#" className="hover:text-gray-400"><FaLinkedin className='size-10' /></a>
            <a href="#" className="hover:text-gray-400"><FaSquareXTwitter className='size-10' /></a>
          </div> */}
        </div>
